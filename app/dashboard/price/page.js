  ...
  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-stretch md:grid-cols-3 md:gap-8">
    <div className="divide-y divide-gray-200 rounded-2xl border border-gray-200 shadow-sm">
      <div className="p-6 sm:px-8">
        ...
        <p className="mt-2 text-gray-700">It will be good for beginners when they are starting.</p>
    ...
    <div className="divide-y divide-gray-200 rounded-2xl border border-gray-200 shadow-sm">
      <div className="p-6 sm:px-8">
        ...
        <p className="mt-2 text-gray-700">It is for office people, employees they got most benefit.</p>
    ...
    <div className="divide-y divide-gray-200 rounded-2xl border border-gray-200 shadow-sm">
      <div className="p-6 sm:px-8">
        ...
        <p className="mt-2 text-gray-700">Big companies  will benefit the most as it is designed for them.</p>
